...
{"english": string, "meaning_ur": string, "example_en": string, "example_ur": string}
...
- "example_en": one natural, simple example sentence using it in context.
- "example_ur": the Urdu translation of that example sentence.
